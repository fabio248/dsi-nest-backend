...
export class ReportsController {
    ...
    @Post('strategic')
    async strategicGenerate(@Res() res: Response, @CurrentUser() user: JwtPayload, @Body() strategicReportDto: StrategicReportDto) {
        return this.pdfGeneratesService.strategicGenerate(res, user, strategicReportDto);
    }
}
